    ...
    const doApplyDamage = () => {
      if (reflected) {
        ...
        showAbilitySplash(blockerName, blockerDesc, 1600, () => {
          ...
          // Cameron: Unstoppable Force — damage cannot be negated, so this block shouldn't trigger when Cameron is attacking.
          // Legacy fallback: if somehow negation fires against Cameron, force damage through.
