...
const SS_SIGILS = [
  ...
  { id: 'comet', name: 'COMET TRAIL', desc: 'SCRY no longer hastens the strike.' },
  { id: 'shield', name: 'SILVER SHIELD', desc: 'Block the first strike of every battle.' },
  { id: 'leech', name: 'DEW DRINKER', desc: 'Every word heals you 1.' },
  { id: 'longbow', name: 'STARRY LONGBOW', desc: 'Words of 6+ letters deal +12.' },
  { id: 'gilded', name: 'GILDED DAWN', desc: 'Every battle begins with a gilded tile.' },
  { id: 'blood', name: 'BLOOD INK', desc: 'Your words +25%. Beast strikes +25%.' },
  { id: 'tome', name: 'WHISPERING TOME', desc: 'The eye ◉ reveals a strong word, once per battle.' },
  { id: 'feather', name: 'PHOENIX FEATHER', desc: 'Once per run, survive death at 1 health.' },
];
