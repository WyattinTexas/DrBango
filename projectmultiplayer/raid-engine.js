...
const RAID_ITEMS = {
  ...
  firefly_lantern:{ name: 'Firefly Lantern',icon: '🏮', type: 'charm', tier: 'rare', slot: 'weapon',
                    desc: 'Start each fight with 1 Magic Firefly. Take 2 damage immediately.' },
  golden_dice:    { name: 'Golden Dice',    icon: '🎲', type: 'legendary', tier: 'legendary', slot: 'accessory',
