...
const GHOSTS = [
  ...
  {id:423, name:"Zippa", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/Beewick.png", ability:"Glimmer", abilityDesc:"Deal +1 damage for each Healing Seed you hold.", category:"Damage Multiplier", set:"Rolling Hills", tags:["Final 50"], designNote:"A beekeeper spirit who has become, over time, more bees than person. The bees represent the Healing Seeds; when the swarm wins they bring back luck. Can whiff entirely (0 Seeds = 0 Lucky Stones) so it actively rewards stacking the Healing Seed economy before swinging. Hard synergy with Gourdling and Chester. Wyatt flag: in a full Healing Seed stack (4–5 seeds) this generates a lot of Lucky Stones per win. Art direction: a small humanoid wrapped in a living golden cloak of bees, beekeeper veil half-raised, calm expression, warm golden buzzing light from the swarm."},
  ...
  {id:446, name:"Mable Stadango", rarity:"rare", maxHp:5, art:"../testroom/art/originals/ForestSpirit.png", ability:"Hex", abilityDesc:"When you place Burn on an enemy Spiritkin, remove 1 enemy die next roll. Win: gain 1 Burn.", category:"Disruption", set:"Rolling Hills", tags:["Final 50"], designNote:"Hooded spirit with glowing green eyes in a purple bioluminescent forest. Mystical, magical, powerful presence."},
  ...
  {id:443, name:"Captain James", rarity:"rare", maxHp:6, art:"../testroom/art/originals/DCKnight.png", ability:"Final Strike", abilityDesc:"Sideline & In Play: Triples or better: gain 2 Sacred Fires.", category:"Resource Generation", set:"Dark Castle", tags:["Final 50"], designNote:"Tall flame-headed Spiritkin knight in white-gold armor with golden scarf, holding blue magic. The hero of Dark Castle. Likable, heroic, aspirational."},
  ...
  {id:365, name:"Tyson", rarity:"common", maxHp:4, art:"../testroom/art/cinder_bunny.png", ability:"Hop", abilityDesc:"Win: choose an enemy sideline Spiritkin. That Spiritkin's sideline ability is disabled until it enters play.", category:"Disruption", set:"Volcanic Isles", designNote:"Clean swap, no triggers."},
  ...
  {id:401, name:"Knight Terror", rarity:"rare", maxHp:7, art:"../testroom/art/knight_terror.webp",
    ability:"Heavy Air", abilityDesc:"While active: after any opponent ability triggers, the enemy active Spiritkin loses 2 HP.",
  ...
  {id:4, name:"Wanderer", rarity:"common", maxHp:8, art:"../testroom/art/originals/Wanderer.png", ability:"Curiosity", abilityDesc:"Roll a straight (consecutive sequence, no repeats): deal +2 damage.", category:"Dice Modifier", set:"Set 1", designNote:"Original card. Intel gatherer."},
  ...
  {id:15, name:"Winston", rarity:"common", maxHp:5, art:"../testroom/art/originals/Winston.png", ability:"Scheme", abilityDesc:"Win: you may swap the enemy active Spiritkin with one from their sideline. Gain +2 dice next roll.", category:"Prediction/Reaction", set:"Set 1", designNote:"Original card. Forced swap on doubles."},
  ...
  {id:17, name:"Boo Brothers", rarity:"common", maxHp:5, art:"../testroom/art/originals/boo_brothers.jpg", ability:"Teamwork", abilityDesc:"Before rolling: you may remove 1 die to gain 1 HP. If you do, deal +1 damage this roll.", category:"HP Recovery", set:"Set 1", designNote:"Original card. Die-for-HP trade."},
  {id:18, name:"Charlie", rarity:"common", maxHp:4, art:"../testroom/art/originals/Charlie.png", ability:"Rush", abilityDesc:"Upon losing a roll, you may Flick one of your dice. Any die hit changes its result on contact.", category:"Prediction/Reaction", set:"Set 1", designNote:"Original card. Double 2s nuke."},
  ...
  {id:50, name:"Jackson", rarity:"uncommon", maxHp:6, art:"../testroom/art/originals/Jackson.png", ability:"Regrow", abilityDesc:"After your roll, you may spend 1 of Jackson's HP to reroll 1 die.", category:"Dice Modifier", set:"Set 1", designNote:"Original card. HP-for-reroll."},
  ...
  {id:72, name:"Sky", rarity:"rare", maxHp:4, art:"../testroom/art/originals/Sky.png", ability:"Elusive", abilityDesc:"If incoming damage is greater than 2: negate it. Sky rolls 1 die and deals its value as damage.", category:"Defense/Negation", set:"Set 1", designNote:"Original card. Big damage immunity."},
  ...
  {id:101, name:"Splinter", rarity:"ghost-rare", maxHp:4, art:"../testroom/art/originals/Splinter.png", ability:"Toxic Fumes", abilityDesc:"Win: deal 1 damage before each roll.", category:"Debuff", set:"Set 1", designNote:"Original card. Stacking poison."},
  ...
  {id:20, name:"Floop", rarity:"common", maxHp:5, art:"../testroom/art/originals/Floop.png", ability:"Muck", abilityDesc:"If the enemy rolls Doubles: they lose 1 die next roll.", category:"Debuff", set:"Dark Castle", designNote:"Dark Castle. Anti-doubles punisher."},
  ...
  // FROST VALLEY
  // ============================================================
  {id:23, name:"Powder", rarity:"common", maxHp:5, art:"../testroom/art/originals/powder.jpg", ability:"Final Gift", abilityDesc:"When defeated: gain 3 Ice Shards for your next Spiritkin.", category:"Resource Generation", set:"Frost Valley", designNote:"Frost Valley. Death-triggered resource gen."},
  ...
  {id:25, name:"Cameron", rarity:"common", maxHp:6, art:"../testroom/art/originals/cameron.jpg", ability:"Unstoppable Force", abilityDesc:"If the opponent uses a special, Cameron gains 1 extra die. Cameron's damage cannot be negated.", category:"Dice Boost/Anti-Negation", set:"Frost Valley", designNote:"Frost Valley. Punishes special usage with bonus dice. Damage pierces all negation."},
  ...
  {id:27, name:"Fredrick", rarity:"common", maxHp:5, art:"../testroom/art/originals/fredrick.jpg", ability:"Careful", abilityDesc:"Before rolling: deal 2 damage for each extra die the enemy rolled above 3 last round.", category:"Disruption", set:"Frost Valley", designNote:"Frost Valley. Dice cap."},
  {id:28, name:"Dream Cat", rarity:"common", maxHp:4, art:"../testroom/art/originals/dream_cat.jpg", ability:"Jinx", abilityDesc:"Both roll Doubles: gain 2 extra dice next roll.", category:"Dice Modifier", set:"Frost Valley", designNote:"Frost Valley. Mutual doubles reward."},
  ...
  {id:31, name:"Gus", rarity:"common", maxHp:6, art:"../testroom/art/originals/gus.jpg", ability:"Gale Force", abilityDesc:"Win: you may force the opponent to swap their active Spiritkin. The new Spiritkin takes the damage.", category:"Disruption", set:"Frost Valley", designNote:"Frost Valley. Win-to-swap instead of damage."},
  ...
  {id:33, name:"Sandwiches", rarity:"common", maxHp:6, art:"../testroom/art/originals/sandwiches.jpg", ability:"Dependable", abilityDesc:"Sideline: if your opponent gains a Special, you gain it as well.", category:"Resource Generation", set:"Frost Valley", designNote:"Frost Valley. Resource mirror."},
  ...
  {id:84, name:"Wandering Sue", rarity:"uncommon", maxHp:4, art:"../testroom/art/originals/wandering_sue.jpg", ability:"Hidden Weakness", abilityDesc:"Before rolling: if the enemy has more HP than Sue, gain 1 extra die.", category:"Dice Modifier", set:"Frost Valley", designNote:"Frost Valley. Anti-overclock assassin."},
  ...
  {id:86, name:"Pelter", rarity:"rare", maxHp:5, art:"../testroom/art/originals/pelter.jpg", ability:"Snowball", abilityDesc:"Doubles: deal +2 damage.", category:"Damage Multiplier", set:"Frost Valley", designNote:"Frost Valley. Doubles damage booster."},
  {id:87, name:"Zach", rarity:"rare", maxHp:7, art:"../testroom/art/originals/zach.jpg", ability:"Craftsman", abilityDesc:"Sideline: Guard Thomas gains +3 damage on Doubles and +1 die each roll.", category:"Damage Multiplier", set:"Frost Valley", designNote:"Frost Valley. Guard Thomas synergy."},
  ...
  {id:89, name:"Mallow", rarity:"rare", maxHp:5, art:"../testroom/art/originals/mallow.jpg", ability:"Dozy Cozy", abilityDesc:"Sideline: before rolling, you may spend 2 Sacred Fire to give your active Spiritkin 3 HP and gain 1 Burn.", category:"HP Recovery", set:"Frost Valley", designNote:"Frost Valley. Sacred Fire healing."},
  ...
  {id:91, name:"Calvin & Anna", rarity:"rare", maxHp:6, art:"../testroom/art/originals/calvin_anna.jpg", ability:"Toboggan", abilityDesc:"Defeat a Spiritkin: you may switch Calvin & Anna with a Spiritkin from your sideline.", category:"Prediction/Reaction", set:"Frost Valley", designNote:"Frost Valley. Kill-swap."},
  ...
  {id:452, name:"Ripagoo", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/Ripagoo.png", ability:"Chemical Y", abilityDesc:"Sideline: if a Spiritkin In Play transforms, gain 2 Burn.", category:"Resource Generation", set:"Volcanic Isles", tags:["Final 50"], designNote:"Sideline observer that feeds off transformation energy."},
  ...
  {id:454, name:"Miyoshi", rarity:"ghost-rare", maxHp:6, art:"../testroom/art/originals/Miyoshi.jpeg", ability:"Bonzai!", abilityDesc:"Before rolling: you may declare 'Bonzai!' — lose 4 HP, then gain 5 extra dice.", category:"Dice Modifier", set:"Volcanic Isles", tags:["Final 50"], designNote:"Water-and-fire spirit. Sacrifice HP for massive dice surge."},
  {id:455, name:"Explorer Jeff", rarity:"rare", maxHp:4, art:"../testroom/art/originals/ExplorerJeff.png", ability:"Treasure Hunter", abilityDesc:"Sideline & In Play: if you hold 3+ different specials, gain 1 extra die and deal +1 damage.", category:"Dice Modifier", set:"Volcanic Isles", tags:["Final 50"], designNote:"The 5th Jeff. Rewards resource diversity from the bench."},
