...
const RAID_BOSSES = {
  ...
  raid_timber: {
    ...
    bossGhost: {
      id: 9201, baseId: 210, name: 'Timber', maxHp: 30, art: '../testroom/art/timber.jpg',
  ...
  raid_dark_fang: {
    ...
    bossGhost: {
      id: 9202, baseId: 202, name: 'Dark Fang', maxHp: 15, art: '../testroom/art/originals/DarkFang.png',
  ...
  raid_jasper: {
    ...
    bossGhost: {
      id: 9203, baseId: 428, name: 'Jasper', maxHp: 16, art: '../testroom/art/originals/Pickwick.png',
  ...
  raid_king_jay: {
    ...
    requiredBadge: null, requiredPlayers: 2,
    bossGhost: {
      id: 9204, baseId: 106, name: 'King Jay', maxHp: 20, art: '../testroom/art/originals/king_jay.jpg',
  ...
  raid_romy: {
    ...
    bossGhost: {
      id: 9206, baseId: 114, name: 'Romy', maxHp: 22, art: '../testroom/art/originals/romy.jpg',
  ...
  raid_pip: {
    ...
    bossGhost: {
      id: 9207, baseId: 418, name: 'Pip', maxHp: 18, art: '../testroom/art/originals/Pip.png',
  ...
  raid_humar: {
    ...
    bossGhost: {
      id: 9208, baseId: 336, name: 'Humar', maxHp: 18, art: '../testroom/art/humar.jpg',
  ...
  raid_lucy: {
    ...
    bossGhost: {
      id: 9210, baseId: 108, name: 'Lucy', maxHp: 20, art: '../testroom/art/originals/lucy.jpg',
  ...
  raid_shade: {
    ...
    requiredBadge: 'dark_castle_key', requiredPlayers: 2,
    bossGhost: {
      id: 9211, baseId: 111, name: 'Shade', maxHp: 16, art: '../testroom/art/originals/shade.jpg',
  ...
  raid_bigsby: {
    ...
    bossGhost: {
      id: 9212, baseId: 424, name: 'Bigsby', maxHp: 18, art: '../testroom/art/originals/Digby.png',
