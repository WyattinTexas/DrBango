...
const GHOSTS = [
  ...
  },
  {
    ...
    ability:"Pressure", abilityDesc:"While active: enemy ghost cannot heal or gain HP. Win: deal +1 damage for each KO'd ghost this game (both teams).",
  ...
  },
  {
    ...
    ability:"Meltdown", abilityDesc:"Sideline: before each roll, if the enemy active ghost has less than 4 HP, deal 1 damage.",
  ...
  },
  {
    ...
    ability:"Ice Blade", abilityDesc:"Win a roll: gain 1 Ice Shard. Sideline & In Play: discard 1 Ice Shard and 1 Moonstone to forge the Ice Blade.",
  ...
  {
    id:210, name:"Timber", rarity:"legendary", maxHp:6, art:"../testroom/art/timber.jpg",
  ...
  // === NEW CARDS — Rolling Hills ===
  {
    ...
    ability:"Sun Song", abilityDesc:"Sideline & In Play: enemy before-roll effects don't activate. On winning rolls, gain 1 Burn.",
  ...
  },
  {
    ...
    ability:"Roaring Crowd", abilityDesc:"Sideline: if your active ghost ties, gain 4 Surge.",
    category:"Resource Generation", set:"Rolling Hills",
  ...
  },
  {
    ...
    ability:"Bedtime Story", abilityDesc:"Sideline: when one of your ghosts is defeated — by singles: gain 2 Lucky Stones. By doubles: gain 1 Moonstone. By triples or better: gain 3 Sacred Fires.",
  ...
  },
  {
    ...
    ability:"Big Target", abilityDesc:"Win a roll: deal +3 damage if the enemy ghost's HP is higher than Timpleton's.",
    category:"Damage Multiplier", set:"Rolling Hills",
  ...
  {id:334, name:"Fiddle", art:"../testroom/art/fiddle.webp", rarity:"uncommon", maxHp:6, ability:"Hoedown", abilityDesc:"Win: you may swap your active ghost without triggering Stomper/Crag effects.", category:"Prediction/Reaction", set:"Rolling Hills", designNote:"Safe swap enabler. Counters Stomper."},
  ...
  {id:342, name:"Calvin", art:"../testroom/art/mossy.webp", rarity:"uncommon", maxHp:5, ability:"Overclock", abilityDesc:"Win: heal +1 HP (can exceed max HP). Gain +1 Healing Seed.", category:"HP Recovery", set:"Rolling Hills", designNote:"Overclocking healer. HP grows beyond max on wins. Snowballs if unchecked."},
  ...
  {id:423, name:"Zippa", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/Beewick.png", ability:"Glimmer", abilityDesc:"Before rolling: gain 1 Lucky Stone for each Healing Seed your team currently holds.", category:"Resource Generation", set:"Rolling Hills", tags:["Final 50"], designNote:"A beekeeper spirit who has become, over time, more bees than person. The bees represent the Healing Seeds; when the swarm wins they bring back luck. Can whiff entirely (0 Seeds = 0 Lucky Stones) so it actively rewards stacking the Healing Seed economy before swinging. Hard synergy with Gourdling and Chester. Wyatt flag: in a full Healing Seed stack (4–5 seeds) this generates a lot of Lucky Stones per win. Art direction: a small humanoid wrapped in a living golden cloak of bees, beekeeper veil half-raised, calm expression, warm golden buzzing light from the swarm."},
  {id:424, name:"Bigsby", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/Digby.png", ability:"Omen", abilityDesc:"Win: deal +1 damage. If you use a Moonstone, you must sacrifice Bigsby and replace him with Doom.", category:"Damage Multiplier", set:"Dark Castle", tags:["Final 50"], designNote:"A mole farmer who has dug through enough hills to know exactly where the shiny things are. Moonstone on entry is clean uncommon-level power — fuels any Moonstone strategy, bridges RH into the Fluxling/Obsidian Eel VA cross-play, and rewards deckbuilders who value die control. Art direction: a stout mole in a dirt-stained work vest, holding a discovered moonstone triumphantly, still has mud on his snout, enormously pleased with himself."},
  {id:426, name:"Chester", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/Chester.png", ability:"Well Read", abilityDesc:"Win: gain 1 Healing Seed. Win with doubles or better: gain 1 Burn instead.", category:"Resource Generation", set:"Rolling Hills", tags:["Final 50"], designNote:"A cheese-cellar dweller who has been down there with the wheels of cheese for a very long time and is extremely satisfied about this. Tiered Healing Seed gen: modest on singles wins, bursts to 2 on doubles+. At 6HP he stays in the fight long enough for those seeds to stack into something meaningful. Core engine for Beewick and The Overcast builds. Art direction: a round softly luminous figure shaped somewhat like a wheel of aged cheese, impossibly dignified expression, surrounded by floating cheese wheels in a warm candlelit stone cellar, moonlight through a cellar grate."},
  {id:427, name:"Garrick", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/Brock.png", ability:"Watchfire", abilityDesc:"Lose: take -1 damage. Gains 1 Sacred Fire if he defeats a Spiritkin.", category:"Defense/Negation", set:"Dark Castle", tags:["Final 50"], designNote:"The rolling hills' unofficial guardian — a badger, specifically. 'Brock' is the old English name for badger. The sett is the stable center of any field. Win or lose, Brock cushions every exchange: hits harder when ahead, takes less when behind. Reliable two-way modifier on a 6HP body. Works as a fighter or a bench presence that makes your active ghost feel safer. Art direction: a dignified badger in a dark well-worn coat, standing on a hillside at dusk, protective expression, white stripe catching the last light."},
  ...
  {id:432, name:"Valkin the Grand", rarity:"legendary", maxHp:8, art:"../testroom/art/originals/ValkinTheGrand.png", ability:"Grand Spoils", abilityDesc:"When you KO an enemy ghost: gain 1 Sacred Fire, 2 Ice Shards, 1 Lucky Stone, 1 Moonstone, 2 Healing Seeds.", category:"Resource Generation", set:"Dark Castle", tags:["Final 50"], designNote:"THE ANTAGONIST LEGENDARY. Valkin the Grand is the main villain of the BOO: Battle of Origins lore — the tyrant who trapped Toby's grandfather and seeks to control the BOO itself. Grand Spoils embodies his greed: every KO pays him the full resource suite. 6 HP is modest-legendary so the snowball has to be earned. Art: Gemini-generated regal spirit monarch on a blue-flame throne. NOTE: this slot previously held Vela (Second Breath resurrection mechanic) — resolver code at lines ~10776 and smartAutoPlay ~1759 still references id 432 for Vela's resurrection trigger. Needs cleanup: either reassign Vela to a new ID or remove the resurrection hook from id 432."},
  {id:433, name:"Lucas", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/Vigil.png", ability:"Kindling", abilityDesc:"Sideline: When a ghost is revived, it charges into play with +3 HP and +1 die next roll. The reviver steps to the sideline.", category:"Resource Generation", set:"Volcanic Isles", tags:["Final 50"], designNote:"Resurrection payoff #2. Flame-family Spiritkin: humanoid body, orange-red torchflame head, flame-orange accessories. Triggers on any resurrection source. 6 Sacred Fires = +18 committed damage on the next winning roll. Pairs with Vela (432) in the resurrection archetype."},
  {id:435, name:"Willow", rarity:"ghost-rare", maxHp:4, art:"../testroom/art/originals/Willow.png", ability:"Joy of Painting", abilityDesc:"Sideline & In Play: gain +1 die if you lost the last roll.", category:"Dice Modifier", set:"Dark Castle", tags:["Final 50"], designNote:"A ghost painter at her easel by a moonlit window. Paints through the night, finds joy in every loss. The comeback mechanic — every defeat fuels the next roll. Bob Ross energy meets Dark Castle. 4HP ghost-rare, fragile but inspiring."},
  {id:436, name:"Princess Shade", rarity:"rare", maxHp:4, art:"../testroom/art/originals/PrincessShade.png", ability:"Bounty", abilityDesc:"While in play & on sideline: when the enemy ghost takes damage before the roll, deal +1 additional damage.", category:"Damage Multiplier", set:"Dark Castle", tags:["Final 50"], designNote:"A dark elegant apparition ascending a grand staircase in a golden-lit castle atrium. Long flowing shadow-form dissolving at the edges. Regal, haunting, beautiful. The princess of the Dark Castle."},
  ...
  {id:445, name:"Michael", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/WaterSpirit.png", ability:"Torrent", abilityDesc:"Even doubles: deal +2 damage. While in play, your sideline ghosts are immune to Burn.", category:"Dice Modifier", set:"Volcanic Isles", tags:["Final 50"], designNote:"Blue water spirit leaping joyfully in front of a waterfall. Frost Valley energy."},
  {id:446, name:"Mable Stadango", rarity:"rare", maxHp:5, art:"../testroom/art/originals/ForestSpirit.png", ability:"Hex", abilityDesc:"Before rolling: you may spend 1 Burn to remove 1 enemy die this roll and gain 1 Sacred Fire.", category:"Disruption", set:"Rolling Hills", tags:["Final 50"], designNote:"Hooded spirit with glowing green eyes in a purple bioluminescent forest. Mystical, magical, powerful presence."},
  {id:447, name:"Professor Hawking", rarity:"rare", maxHp:2, art:"../testroom/art/originals/ProfessorHawking.png", ability:"Wisdom", abilityDesc:"While in play: gain +2 dice if you are holding a Moonstone.", category:"Dice Modifier", set:"Rolling Hills", tags:["Final 50"], designNote:"Pixel art ghost owl reading a golden book on a tree branch at sunset. Wise, scholarly, charming."},
  {id:448, name:"Harvey", rarity:"uncommon", maxHp:6, art:"../testroom/art/originals/TreeMonster.png", ability:"Harvest Moon", abilityDesc:"Win: deal +1 damage for each 5 you rolled. If you rolled any 5s, gain 1 Moonstone.", category:"Resource Generation", set:"Dark Castle", tags:["Final 50"], designNote:"Massive dark tree creature with a wide glowing grin and moonlight orb. Menacing but charming. Tank energy."},
  {id:444, name:"Goobs", rarity:"common", maxHp:4, art:"../testroom/art/originals/GoobParty.png", ability:"Dance Party", abilityDesc:"Sideline & In Play: on a tie, both players gain 1 Magic Firefly. +5 HP to your current Ghost in Play.", category:"Resource Generation", set:"Rolling Hills", tags:["Final 50"], designNote:"A field full of tiny green blobs dancing under a moonlit sky. The happiest, dumbest card in the game. Ties become resource explosions for both sides. 2HP because the Goobs die if you look at them wrong. Pure party energy."},
  {id:443, name:"Captain James", rarity:"rare", maxHp:6, art:"../testroom/art/originals/DCKnight.png", ability:"Final Strike", abilityDesc:"Roll: if you roll triples or higher, gain 2 Sacred Fires.", category:"Resource Generation", set:"Dark Castle", tags:["Final 50"], designNote:"Tall flame-headed Spiritkin knight in white-gold armor with golden scarf, holding blue magic. The hero of Dark Castle. Likable, heroic, aspirational."},
  ...
  {id:438, name:"Champ", rarity:"ghost rare", maxHp:5, art:"../testroom/art/originals/Champ.png", ability:"Thrill", abilityDesc:"Immune to damage from Specials. Gains +1 Surge when you or the enemy rolls doubles or higher.", category:"Defense/Negation", set:"Dark Castle", tags:["Final 50"], designNote:"A hulking blue-grey flame beast with orange fire mane standing in a grand cathedral hall. Fierce fanged grin, powerful stance. The mid-tier brawler of Dark Castle. Watercolor meets Pokemon Gengar energy."},
  ...
  {id:345, name:"Red Hunter", art:"../testroom/art/tremor.webp", rarity:"ghost-rare", maxHp:6, ability:"Rumble", abilityDesc:"Win a roll: if your opponent has any specials, deal +3 damage.", category:"Damage Multiplier", set:"Volcanic Isles", designNote:"Punishes hoarders. Logic was already correct — only fires on a winning roll. Text now matches behavior."},
  ...
  {id:365, name:"Tyson", rarity:"common", maxHp:4, art:"../testroom/art/cinder_bunny.png", ability:"Hop", abilityDesc:"Win: choose an enemy sideline ghost. That ghost's sideline ability is disabled until it enters play.", category:"Disruption", set:"Volcanic Isles", designNote:"Clean swap, no triggers."},
  ...
  // === EJ'S GHOSTS ===
  {id:401, name:"Knight Terror", rarity:"rare", maxHp:7, art:"../testroom/art/knight_terror.webp",
    ability:"Heavy Air", abilityDesc:"While active: after any opponent ability triggers and resolves, the enemy active ghost loses 2 HP.",
  ...
  {id:4, name:"Wanderer", rarity:"common", maxHp:8, art:"../testroom/art/originals/Wanderer.png", ability:"Curiosity", abilityDesc:"Roll a straight (consecutive sequence, no repeats): deal +2 damage.", category:"Prediction/Reaction", set:"Set 1", designNote:"Original card. Intel gatherer."},
  ...
  {id:6, name:"Fang Outside", rarity:"common", maxHp:2, art:"../testroom/art/originals/FangOutside.png", ability:"Skillful Coward", abilityDesc:"When Fang wins a roll, you may switch with a ghost on your sideline after damage.", category:"Prediction/Reaction", set:"Set 1", designNote:"Original card. Hit-and-run."},
  {id:7, name:"Fang Undercover", rarity:"common", maxHp:2, art:"../testroom/art/originals/FangUndercover.png", ability:"Skilled Coward", abilityDesc:"When taking damage, you may switch this ghost with any of your sideline ghosts and negate damage.", category:"Defense/Negation", set:"Set 1", designNote:"Original card. Damage dodge."},
  ...
  {id:9, name:"Little Boo", rarity:"common", maxHp:2, art:"../testroom/art/originals/LittleBoo.png", ability:"Mercy", abilityDesc:"Enemy rolled triples count as a 1,2,3 roll instead.", category:"Defense/Negation", set:"Set 1", designNote:"Original card. Triple negator."},
  ...
  {id:11, name:"Villager", rarity:"common", maxHp:4, art:"../testroom/art/originals/Villager.png", ability:"Hospitality", abilityDesc:"While on the sideline, the ghost in battle gains +1 health every winning roll.", category:"HP Recovery", set:"Set 1", designNote:"Original card. Sideline healer."},
  {id:12, name:"Dupy", rarity:"common", maxHp:4, art:"../testroom/art/originals/Dupy.png", ability:"Frolic", abilityDesc:"Rolling a tie instant KOs the opposing ghost.", category:"Destruction/Instant Kill", set:"Set 1", designNote:"Original card. Tie = death."},
  {id:13, name:"Shoo", rarity:"common", maxHp:4, art:"../testroom/art/originals/Shoo.png", ability:"Alpine Air", abilityDesc:"If on the sideline, the ghost in play gains +2 health when their health is less than 4. Only Once Per Ghost.", category:"HP Recovery", set:"Set 1", designNote:"Original card. Emergency heal."},
  {id:14, name:"Jeffery", rarity:"common", maxHp:5, art:"../testroom/art/originals/Jeffery.png", ability:"Chuckle", abilityDesc:"If on sideline and your ghost wins a battle, ghost in play gains 3 HP.", category:"HP Recovery", set:"Set 1", designNote:"Original card. Win-triggered sideline healer."},
  {id:15, name:"Winston", rarity:"common", maxHp:5, art:"../testroom/art/originals/Winston.png", ability:"Scheme", abilityDesc:"Win: you may swap your opponent's ghost with one from their sideline. Gain +2 dice next roll.", category:"Prediction/Reaction", set:"Set 1", designNote:"Original card. Forced swap on doubles."},
  {id:16, name:"Chip", rarity:"common", maxHp:4, art:"../testroom/art/originals/Chip.png", ability:"Acrobatic Dive", abilityDesc:"Your even rolled doubles add +3 damage if you deal damage.", category:"Damage Multiplier", set:"Set 1", designNote:"Original card. Even doubles specialist."},
  {id:17, name:"Boo Brothers", rarity:"common", maxHp:5, art:"../testroom/art/originals/boo_brothers.jpg", ability:"Teamwork", abilityDesc:"Before rolling, may remove 1 die to gain 1 HP.", category:"HP Recovery", set:"Set 1", designNote:"Original card. Die-for-HP trade."},
  {id:18, name:"Charlie", rarity:"common", maxHp:4, art:"../testroom/art/originals/Charlie.png", ability:"Rush", abilityDesc:"Double 2's hit for 7.", category:"Damage Multiplier", set:"Set 1", designNote:"Original card. Double 2s nuke."},
  {id:34, name:"Grawr", rarity:"uncommon", maxHp:7, art:"../testroom/art/originals/Grawr.png", ability:"Menace", abilityDesc:"When Grawr enters the battle, deal 1 damage to the opponent.", category:"Damage Multiplier", set:"Set 1", designNote:"Original card. Entry damage."},
  ...
  {id:36, name:"Bill & Bob", rarity:"uncommon", maxHp:6, art:"../testroom/art/originals/Bill&Bob.png", ability:"Bait n Switch", abilityDesc:"While below 4 health, deal 2X damage on winning rolls.", category:"Damage Multiplier", set:"Set 1", designNote:"Original card. Low HP berserker."},
  {id:37, name:"Dealer", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/Dealer.png", ability:"House Rules", abilityDesc:"Roll a straight: +3 damage and negate all incoming damage.", category:"Defense/Negation", set:"Set 1", designNote:"Original card. Sequence shield."},
  {id:38, name:"Alucard", rarity:"uncommon", maxHp:4, art:"../testroom/art/originals/Alucard.png", ability:"Colony Call", abilityDesc:"Doubles deal +2 damage for each ghost on your sideline. Once Per Game.", category:"Damage Multiplier", set:"Set 1", designNote:"Original card. Sideline-scaling nuke."},
  {id:39, name:"Castle Guards", rarity:"uncommon", maxHp:7, art:"../testroom/art/originals/CastleGuards.png", ability:"Flamethrower", abilityDesc:"Any 3's you roll multiplies Castle Guard's damage by 2 each.", category:"Damage Multiplier", set:"Set 1", designNote:"Original card. 3s matter."},
  {id:40, name:"Team Zippy", rarity:"uncommon", maxHp:7, art:"../testroom/art/originals/TeamZippy.png", ability:"Teamwork", abilityDesc:"Any single damage you inflict deals +2 damage.", category:"Damage Multiplier", set:"Set 1", designNote:"Original card. Singles booster."},
  ...
  {id:42, name:"Doc", rarity:"uncommon", maxHp:2, art:"../testroom/art/originals/Doc.png", ability:"Savage", abilityDesc:"+5 damage when you roll doubles.", category:"Damage Multiplier", set:"Set 1", designNote:"Original card. Glass cannon."},
  {id:43, name:"Outlaw", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/outlaw.jpg", ability:"Thief", abilityDesc:"Roll doubles: remove 1 opponent die next turn.", category:"Debuff", set:"Set 1", designNote:"Original card. Die stealer."},
  ...
  {id:45, name:"Cornelius", rarity:"uncommon", maxHp:2, art:"../testroom/art/originals/Cornelius.png", ability:"Antidote", abilityDesc:"While on the sideline, negate all enemy sideline effects.", category:"Defense/Negation", set:"Set 1", designNote:"Original card. Sideline silencer."},
  ...
  {id:47, name:"Hermit", rarity:"uncommon", maxHp:3, art:"../testroom/art/originals/Hermit.png", ability:"Solitude", abilityDesc:"Upon entry, gain +2 health for each ghost defeated on both teams.", category:"HP Recovery", set:"Set 1", designNote:"Original card. Late-game scaling tank."},
  {id:48, name:"Opa", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/Opa.png", ability:"Rest", abilityDesc:"If Opa wins the roll or ties, gain +1 health.", category:"HP Recovery", set:"Set 1", designNote:"Original card. Win/tie healer."},
  {id:49, name:"Greg", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/Greg.png", ability:"Chase", abilityDesc:"If Greg has more health than the opposing ghost, Greg's rolls do x2 damage.", category:"Damage Multiplier", set:"Set 1", designNote:"Original card. HP-advantage doubler."},
  {id:50, name:"Jackson", rarity:"uncommon", maxHp:3, art:"../testroom/art/originals/Jackson.png", ability:"Regrow", abilityDesc:"After your roll, you may remove 1 of Jackson's health to reroll 1 of the dice.", category:"Dice Modifier", set:"Set 1", designNote:"Original card. HP-for-reroll."},
  {id:62, name:"Raditz", rarity:"rare", maxHp:6, art:"../testroom/art/originals/Raditz.png", ability:"Hunt", abilityDesc:"When Raditz enters the battle, you may switch the opposing ghost with a different ghost from their sideline.", category:"Prediction/Reaction", set:"Set 1", designNote:"Original card. Entry forced swap."},
  {id:63, name:"Doug", rarity:"rare", maxHp:3, art:"../testroom/art/originals/Doug.png", ability:"Caution", abilityDesc:"Before rolling, Doug may switch with a sideline ghost once per game. Then, gain +1 dice your next roll.", category:"Dice Modifier", set:"Set 1", designNote:"Original card. Safe swap + bonus die."},
  ...
  {id:66, name:"Munch", rarity:"rare", maxHp:6, art:"../testroom/art/originals/Munch.png", ability:"Scraps", abilityDesc:"Upon defeating a ghost, gain 4 health.", category:"HP Recovery", set:"Set 1", designNote:"Original card. Kill-to-heal."},
  ...
  {id:68, name:"Kairan", rarity:"rare", maxHp:4, art:"../testroom/art/originals/kairan.jpg", ability:"Let's Dance", abilityDesc:"Roll doubles: +1 die next roll.", category:"Dice Modifier", set:"Set 1", designNote:"Original card. Doubles = dice growth."},
  {id:69, name:"Sonya", rarity:"rare", maxHp:3, art:"../testroom/art/originals/Sonya.png", ability:"Mesmerize", abilityDesc:"You may change one of your dice results to a 2 each roll.", category:"Dice Modifier", set:"Set 1", designNote:"Original card. Guaranteed 2 manipulation."},
  ...
  {id:71, name:"Admiral", rarity:"rare", maxHp:3, art:"../testroom/art/originals/Admiral.png", ability:"Comrades", abilityDesc:"While on the sideline, +2 damage to your even doubles rolls.", category:"Damage Multiplier", set:"Set 1", designNote:"Original card. Sideline doubles booster."},
  {id:72, name:"Sky", rarity:"rare", maxHp:4, art:"../testroom/art/originals/Sky.png", ability:"Elusive", abilityDesc:"If incoming damage is greater than 2, the damage is negated.", category:"Defense/Negation", set:"Set 1", designNote:"Original card. Big damage immunity."},
  ...
  {id:74, name:"Dark Jeff", rarity:"rare", maxHp:3, art:"../testroom/art/originals/DarkJeff.png", ability:"Cackle", abilityDesc:"While on the sideline, +1 damage to all your rolls.", category:"Damage Multiplier", set:"Set 1", designNote:"Original card. Passive sideline damage."},
  {id:75, name:"Flora", rarity:"rare", maxHp:4, art:"../testroom/art/originals/flora.jpg", ability:"Restore", abilityDesc:"Roll doubles: +2 HP after damage is applied.", category:"HP Recovery", set:"Set 1", designNote:"Original card. The very first card Wyatt made as a kid."},
  {id:76, name:"Dark Wing", rarity:"rare", maxHp:2, art:"../testroom/art/originals/DarkWing.png", ability:"Precision", abilityDesc:"Once per game, if Dark Wing rolls singles, he may reroll all his dice.", category:"Dice Modifier", set:"Set 1", designNote:"Original card. One-shot precision reroll — only offered on singles (doubles or better is already fine)."},
  {id:77, name:"City Cyboo", rarity:"rare", maxHp:1, art:"../testroom/art/originals/CityCyboo.png", ability:"Barrier", abilityDesc:"Takes no damage from Enemy Doubles.", category:"Defense/Negation", set:"Set 1", designNote:"Original card. 1 HP doubles immune."},
  {id:94, name:"Jenkins", rarity:"ghost-rare", maxHp:5, art:"../testroom/art/originals/Jenkins.png", ability:"Greeting", abilityDesc:"When Jenkins enters the battle, roll 4 dice to inflict damage once.", category:"Damage Multiplier", set:"Set 1", designNote:"Original card. Entry nuke."},
  {id:95, name:"Tabitha", rarity:"ghost-rare", maxHp:1, art:"../testroom/art/originals/Tabitha.png", ability:"Rally", abilityDesc:"While on the sideline, +2 damage to your doubles rolls.", category:"Damage Multiplier", set:"Set 1", designNote:"Original card. Sideline doubles buff."},
  {id:99, name:"Guardian Fairy", rarity:"ghost-rare", maxHp:3, art:"../testroom/art/originals/GuardianFairy.png", ability:"Wish", abilityDesc:"Sideline: when your active ghost is about to take damage, Guardian Fairy can leap in and take the hit instead.", category:"Defense/Negation", set:"Set 1", designNote:"Original card. Sacrifice bodyguard."},
  {id:100, name:"Cyboo", rarity:"ghost-rare", maxHp:3, art:"../testroom/art/originals/Cyboo.png", ability:"Spark", abilityDesc:"While on the sideline, your ghost in play gains +1 dice if they have less than 3 health.", category:"Dice Modifier", set:"Set 1", designNote:"Original card. Low HP dice boost."},
  {id:101, name:"Splinter", rarity:"ghost-rare", maxHp:4, art:"../testroom/art/originals/Splinter.png", ability:"Toxic Fumes", abilityDesc:"After winning a roll, deal 1 damage before every roll.", category:"Debuff", set:"Set 1", designNote:"Original card. Stacking poison."},
  {id:109, name:"Bo", rarity:"legendary", maxHp:5, art:"../testroom/art/originals/Bo.png", ability:"Miracle", abilityDesc:"Upon defeating a Ghost, return one of your defeated Ghosts to your sideline. Gain 1 Magic Firefly.", category:"HP Recovery", set:"Set 1", designNote:"Original legendary. Resurrection on kill."},
  ...
  {id:51, name:"Nicholas", rarity:"uncommon", maxHp:1, art:"../testroom/art/originals/nicholas.jpg", ability:"Sneak Attack", abilityDesc:"While on the sideline, deal 2 damage to the enemy ghost when they enter play.", category:"Damage Multiplier", set:"Dark Castle", designNote:"Dark Castle. Entry punisher."},
  {id:52, name:"Hugo", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/Hugo.png", ability:"Wreckage", abilityDesc:"Your opponent loses 1 die their next roll when Hugo takes roll damage.", category:"Debuff", set:"Dark Castle", designNote:"Dark Castle. Damage retaliation."},
  {id:78, name:"Haywire", rarity:"rare", maxHp:7, art:"../testroom/art/originals/Haywire.png", ability:"Wild Chords", abilityDesc:"Upon rolling triples or better: gain 1 permanent die. Haywire gains +2 permanent damage. Once per game.", category:"Dice Modifier", set:"Dark Castle", tags:["Final 50"], designNote:"Dark Castle. Main character — dice growth + personal damage snowball. Two subjects: the die belongs to the player's pool, the +2 damage is Haywire's personal buff."},
  {id:79, name:"Laura", rarity:"rare", maxHp:4, art:"../testroom/art/originals/laura.jpg", ability:"Catchy Tune", abilityDesc:"Roll a straight to unlock Catchy Tune. Catchy Tune: choose one die after each roll to lock for the next roll.", category:"Dice Modifier", set:"Rolling Hills", designNote:"Rolling Hills. Straight unlocks permanent die-lock. Player chooses which die to carry over."},
  {id:80, name:"Bilbo", rarity:"rare", maxHp:2, art:"../testroom/art/originals/bilbo.jpg", ability:"Little Buddy", abilityDesc:"While on the sideline, your ghost in play gains +2 damage if you roll singles.", category:"Damage Multiplier", set:"Dark Castle", designNote:"Dark Castle. Sideline singles booster."},
  ...
  {id:97, name:"Toby", rarity:"ghost-rare", maxHp:7, art:"../testroom/art/originals/Toby.png", ability:"Pure Heart", abilityDesc:"Before rolling you may declare the final roll. Toby is defeated next turn before rolling. Winning this roll defeats the enemy ghost.", category:"Destruction/Instant Kill", set:"Dark Castle", designNote:"Dark Castle ghost-rare. All-in gamble."},
  {id:98, name:"Redd", rarity:"ghost-rare", maxHp:7, art:"../testroom/art/originals/Redd.png", ability:"Notorious", abilityDesc:"When Redd enters the battle, gain +2 dice this roll.", category:"Dice Modifier", set:"Dark Castle", designNote:"Dark Castle ghost-rare. Entry dice burst."},
  ...
  // FROST VALLEY
  // ============================================================
  {id:23, name:"Powder", rarity:"common", maxHp:5, art:"../testroom/art/originals/powder.jpg", ability:"Final Gift", abilityDesc:"When defeated, gain 3 Ice Shards for your next ghost.", category:"Resource Generation", set:"Frost Valley", designNote:"Frost Valley. Death-triggered resource gen."},
  {id:24, name:"Simon", rarity:"common", maxHp:7, art:"../testroom/art/originals/simon.jpg", ability:"Brew Time", abilityDesc:"Gain 2 Sacred Fire when taking before-roll damage. Gain 2 Sacred Fire when the enemy rolls triples or better.", category:"Resource Generation", set:"Frost Valley", designNote:"Frost Valley. Pre-roll fire + triples punisher."},
  {id:25, name:"Cameron", rarity:"common", maxHp:6, art:"../testroom/art/originals/cameron.jpg", ability:"Unstoppable Force", abilityDesc:"If the opponent uses a special, Cameron gains +1 die immediately.\nCameron's damage cannot be negated.", category:"Dice Boost/Anti-Negation", set:"Frost Valley", designNote:"Frost Valley. Punishes special usage with bonus dice. Damage pierces all negation."},
  ...
  {id:27, name:"Fredrick", rarity:"common", maxHp:5, art:"../testroom/art/originals/fredrick.jpg", ability:"Careful", abilityDesc:"Opponent may only roll up to 3 dice.", category:"Debuff", set:"Frost Valley", designNote:"Frost Valley. Dice cap."},
  {id:28, name:"Dream Cat", rarity:"common", maxHp:4, art:"../testroom/art/originals/dream_cat.jpg", ability:"Jinx", abilityDesc:"Both roll doubles: gain +1 die next turn.", category:"Dice Modifier", set:"Frost Valley", designNote:"Frost Valley. Mutual doubles reward."},
  {id:29, name:"Sad Sal", rarity:"common", maxHp:5, art:"../testroom/art/originals/sad_sal.jpg", ability:"Tough Job", abilityDesc:"Lose a roll: gain 1 Ice Shard.", category:"Resource Generation", set:"Frost Valley", designNote:"Frost Valley. Loss-triggered resources."},
  {id:30, name:"Tommy Salami", rarity:"common", maxHp:6, art:"../testroom/art/originals/tommy_salami_new.png", ability:"Regulator", abilityDesc:"When you roll a 6, gain +1 die and roll it immediately. Repeats as long as you keep rolling 6s.", category:"Dice Modifier", set:"Frost Valley", tags:["Final 50"], designNote:"Frost Valley. Chain-6s bonus dice."},
  {id:31, name:"Gus", rarity:"common", maxHp:6, art:"../testroom/art/originals/gus.jpg", ability:"Gale Force", abilityDesc:"Win: you may force your opponent to swap their active ghost. The new ghost takes the damage.", category:"Disruption", set:"Frost Valley", designNote:"Frost Valley. Win-to-swap instead of damage."},
  {id:32, name:"Lou", rarity:"common", maxHp:7, art:"../testroom/art/originals/lou.jpg", ability:"Bros", abilityDesc:"While on the sideline, Grawr gains +1 Damage and +1 Health on Winning Rolls.", category:"Damage Multiplier", set:"Frost Valley", designNote:"Frost Valley. Grawr synergy."},
  {id:33, name:"Sandwiches", rarity:"common", maxHp:6, art:"../testroom/art/originals/sandwiches.jpg", ability:"Dependable", abilityDesc:"While on the sideline, if your opponent gains a Special, you gain it as well.", category:"Resource Generation", set:"Frost Valley", designNote:"Frost Valley. Resource mirror."},
  ...
  {id:56, name:"Chad", rarity:"common", maxHp:6, art:"../testroom/art/originals/chad.jpg", ability:"Sploop!", abilityDesc:"On entry, gain 2 Ice Shards.", category:"Resource Generation", set:"Frost Valley", designNote:"Frost Valley. Entry resource gen."},
  {id:57, name:"Marcus", rarity:"uncommon", maxHp:7, art:"../testroom/art/originals/marcus.jpg", ability:"Glacial Pounding", abilityDesc:"Take 3+ damage: YOU gain 4 extra dice on the next roll.", category:"Dice Modifier", set:"Frost Valley", designNote:"Frost Valley. Big hit = big retaliation. Bonus goes to player (next active ghost), not just Marcus."},
  {id:58, name:"Ashley", rarity:"uncommon", maxHp:3, art:"../testroom/art/originals/ashley.jpg", ability:"Burning Soul", abilityDesc:"Win a roll: gain 1 Sacred Fire.", category:"Resource Generation", set:"Frost Valley", designNote:"Frost Valley. Win-triggered Sacred Fire."},
  {id:59, name:"Mr Filbert", rarity:"common", maxHp:6, art:"../testroom/art/originals/mr_filbert.jpg", ability:"Mask Merchant", abilityDesc:"While on the sideline, any healing instead deals damage to the intended ghost.", category:"Debuff", set:"Frost Valley", designNote:"Frost Valley. Anti-healing."},
  {id:60, name:"Dallas", rarity:"uncommon", maxHp:4, art:"../testroom/art/originals/dallas.jpg", ability:"Quick Draw", abilityDesc:"When coming off the sideline, steal 1 of your opponents die for the first 2 rolls.", category:"Dice Modifier", set:"Frost Valley", designNote:"Frost Valley. Entry die theft."},
  {id:61, name:"Suspicious Jeff", rarity:"uncommon", maxHp:4, art:"../testroom/art/originals/suspicious_jeff.jpg", ability:"Snicker", abilityDesc:"While on the sideline, if your Ghost wins a battle, steal 1 of the enemy dice next roll.", category:"Debuff", set:"Frost Valley", designNote:"Frost Valley. Sideline die theft."},
  {id:81, name:"Spockles", rarity:"rare", maxHp:6, art:"../testroom/art/originals/spockles.jpg", ability:"Valley Magic", abilityDesc:"Win a roll: gain 2 Ice Shards.", category:"Resource Generation", set:"Frost Valley", designNote:"Frost Valley. Ice Shard farmer."},
  {id:82, name:"Antoinette", rarity:"uncommon", maxHp:6, art:"../testroom/art/originals/antoinette.jpg", ability:"Grace", abilityDesc:"Roll as many dice as your opponent rolls. +1 Damage on doubles.", category:"Dice Modifier", set:"Frost Valley", designNote:"Frost Valley. Dice mirroring."},
  {id:83, name:"Troubling Haters", rarity:"uncommon", maxHp:3, art:"../testroom/art/originals/troubling_haters.jpg", ability:"Growing Mob", abilityDesc:"Deal 4+ damage in a turn: gain +2 HP.", category:"HP Recovery", set:"Frost Valley", designNote:"Frost Valley. Big damage = HP growth."},
  {id:84, name:"Wandering Sue", rarity:"uncommon", maxHp:4, art:"../testroom/art/originals/wandering_sue.jpg", ability:"Hidden Weakness", abilityDesc:"If enemy has 12+ HP, destroy them before rolling.", category:"Destruction/Instant Kill", set:"Frost Valley", designNote:"Frost Valley. Anti-overclock assassin."},
  ...
  {id:86, name:"Pelter", rarity:"rare", maxHp:5, art:"../testroom/art/originals/pelter.jpg", ability:"Snowball", abilityDesc:"Doubles gain +2 damage.", category:"Damage Multiplier", set:"Frost Valley", designNote:"Frost Valley. Doubles damage booster."},
  {id:87, name:"Zach", rarity:"rare", maxHp:7, art:"../testroom/art/originals/zach.jpg", ability:"Craftsman", abilityDesc:"While on the sideline, Guard Thomas gains +3 damage on Doubles.", category:"Damage Multiplier", set:"Frost Valley", designNote:"Frost Valley. Guard Thomas synergy."},
  {id:88, name:"Pale Nimbus", rarity:"rare", maxHp:4, art:"../testroom/art/originals/pale_nimbus.jpg", ability:"Hidden Storm", abilityDesc:"While on the sideline, add +2 Damage if your total roll result adds to less than 7.", category:"Damage Multiplier", set:"Frost Valley", designNote:"Frost Valley. Low-roll sideline booster."},
  {id:89, name:"Mallow", rarity:"rare", maxHp:5, art:"../testroom/art/originals/mallow.jpg", ability:"Dozy Cozy", abilityDesc:"While on the sideline, before rolling you may spend 2 Sacred Fire to give your Ghost in Play 3 Health and gain 1 Burn.", category:"HP Recovery", set:"Frost Valley", designNote:"Frost Valley. Sacred Fire healing."},
  {id:90, name:"Jeanie", rarity:"rare", maxHp:4, art:"../testroom/art/originals/jeanie.jpg", ability:"Hidden Treasure", abilityDesc:"While on the sideline, you may force the opponent to reroll all their dice. Once Per Game.", category:"Dice Modifier", set:"Frost Valley", designNote:"Frost Valley. One-shot reroll."},
  {id:91, name:"Calvin & Anna", rarity:"rare", maxHp:6, art:"../testroom/art/originals/calvin_anna.jpg", ability:"Toboggan", abilityDesc:"When you defeat a Ghost, you may switch Calvin & Anna with a ghost from your sideline.", category:"Prediction/Reaction", set:"Frost Valley", designNote:"Frost Valley. Kill-swap."},
  ...
  {id:93, name:"Bandit Pete", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/bandit_pete.jpg", ability:"Bandit", abilityDesc:"While on the Sideline, if either player rolls only 2 dice, your ghost in play gains +3 Damage.", category:"Damage Multiplier", set:"Frost Valley", designNote:"Frost Valley. Low-dice sideline booster."},
  {id:103, name:"Night Master", rarity:"ghost-rare", maxHp:5, art:"../testroom/art/originals/night_master.jpg", ability:"Bullseye", abilityDesc:"If you roll doubles and win the roll, immediately destroy a ghost on the enemy sideline that has less than 4 HP.", category:"Destruction/Instant Kill", set:"Frost Valley", designNote:"Frost Valley ghost-rare. Sideline sniper."},
  ...
  {id:105, name:"Tyler", rarity:"ghost-rare", maxHp:7, art:"../testroom/art/originals/tyler.jpg", ability:"Heating Up", abilityDesc:"Before rolling, spend 2 HP to gain +1 die. Sacred Fires deal x2.", category:"Dice Modifier", set:"Frost Valley", designNote:"Frost Valley ghost-rare. HP-for-dice + Sacred Fire doubler."},
  ...
  {id:107, name:"Piper", rarity:"ghost-rare", maxHp:6, art:"../testroom/art/originals/piper.jpg", ability:"Slick Coat", abilityDesc:"Negate enemy before-rolling effects. -1 enemy die next roll. Win with singles: gain 1 Sacred Fire.", category:"Debuff", set:"Frost Valley", designNote:"Frost Valley ghost-rare. Pre-roll negation + die reduction + singles Sacred Fire."},
  {id:113, name:"Prince Balatron", rarity:"legendary", maxHp:6, art:"../testroom/art/originals/balatron.jpg", ability:"Party Time", abilityDesc:"Lose a roll & survive: roll 1 counter die for damage.", category:"Prediction/Reaction", set:"Frost Valley", designNote:"Frost Valley legendary. Counter-attack on loss."},
  ...
  {id:449, name:"Carpenter", rarity:"common", maxHp:4, art:"../testroom/art/originals/Carpenter.png", ability:"Crafty", abilityDesc:"Win: +2 damage on singles. If you use a Surge, transform into Welder. Gain the Hammer.", category:"Evolution", set:"Volcanic Isles", tags:["Final 50"], designNote:"Blue-collar evolution chain entry."},
  {id:450, name:"Welder", rarity:"rare", maxHp:5, art:"../testroom/art/originals/Welder.png", ability:"Flux", abilityDesc:"Win: gain 1 Burn. Roll a 4: transform into Foreman. Gain the Torch.", category:"Evolution", set:"Volcanic Isles", tags:["Final 50"], designNote:"Mid-evolution. Burn specialist."},
  {id:451, name:"Foreman", rarity:"rare", maxHp:5, art:"../testroom/art/originals/Foreman.png", ability:"Blueprint", abilityDesc:"Win: +1 die next roll.", category:"Evolution", set:"Volcanic Isles", tags:["Final 50"], designNote:"End of the blue-collar chain. Foreman snowballs dice on wins."},
  {id:452, name:"Ripagoo", rarity:"uncommon", maxHp:5, art:"../testroom/art/originals/Ripagoo.png", ability:"Chemical Y", abilityDesc:"Sideline: if a card in play transforms, gain 2 Burn.", category:"Resource Generation", set:"Volcanic Isles", tags:["Final 50"], designNote:"Sideline observer that feeds off transformation energy."},
  ...
  {id:454, name:"Miyoshi", rarity:"ghost-rare", maxHp:6, art:"../testroom/art/originals/Miyoshi.jpeg", ability:"Bonzai!", abilityDesc:"Before rolling: you may declare 'Bonzai!' — lose 4 HP first, then gain +5 dice.", category:"Dice Modifier", set:"Volcanic Isles", tags:["Final 50"], designNote:"Water-and-fire spirit. Sacrifice HP for massive dice surge."},
  {id:455, name:"Explorer Jeff", rarity:"rare", maxHp:4, art:"../testroom/art/originals/ExplorerJeff.png", ability:"Treasure Hunter", abilityDesc:"While on the sideline or in play: if you hold 3+ different specials, gain +1 die and +1 damage.", category:"Dice Modifier", set:"Volcanic Isles", tags:["Final 50"], designNote:"The 5th Jeff. Rewards resource diversity from the bench."},
  ...
  {id:457, name:"Sophia", rarity:"rare", maxHp:6, art:"../testroom/art/originals/Sophia.png", ability:"Masquerade", abilityDesc:"On Win: you may deal no damage. If you do, gain Mask of Day or Mask of Night (once per game).", category:"Resource Generation", set:"Dark Castle", tags:["Final 50"], designNote:"Ghost girl choosing between two masks. Mask of Day: gain 1 Burn for each 1 or 2 you roll. Mask of Night: roll the same number of dice as the enemy ghost, +1 damage. Masks are toggleable items like Ice Blade."},
  ...
  {id:461, name:"Ronan", rarity:"common", maxHp:5, art:"../testroom/art/ronan.png", ability:"Mixup", abilityDesc:"If you roll doubles, gain +1 Ice Shard & +1 Burn.", category:"Resource Generation", set:"Volcanic Isles", tags:["Final 50"], designNote:"Flame-headed Spiritkin meditating under a waterfall. Fire meets water — doubles generate both ice and fire resources."},
  ...
  {id:463, name:"Zork", rarity:"common", maxHp:4, art:"../testroom/art/zork.png", ability:"Smolder", abilityDesc:"Before rolling: discard Burn to gain +1 die per Burn discarded.", category:"Dice Modifier", set:"Volcanic Isles", tags:["Final 50"], designNote:"Pterodactyl Spiritkin in a crystal cave. Converts burn fuel into raw dice power."},
  {id:464, name:"Yawn Eater", rarity:"uncommon", maxHp:7, art:"../testroom/art/originals/YawnEater.png", ability:"Feast", abilityDesc:"Gain +1 die for each sideline ability on the enemy sideline. Odd doubles deal +1 damage.", category:"Dice Modifier", set:"Dark Castle", tags:["Final 50"], designNote:"Ghost #200. A smug blobby shadow creature that devours sideline energy. The more passive effects your opponent stacks, the more dice Yawn Eater rolls."}
];
